...
public class Enemy : EntityEngine, IFreezable
{
	...
	private static ILoot[] lootsForDefault_Global = new ILoot[] { new Coin(), new Coin(), new Heal(), new Experience(), new Experience(), new Experience() };
	...
	public static List<GameObject> Enemys = new();
