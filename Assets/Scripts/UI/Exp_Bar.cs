...
public class Exp_Bar : MonoBehaviour
{
    ...
    {
        Debug.Log($"Exp: {PlayerStatistics.Experience}, ExpCurForLVL: {PlayerStatistics.ExpCurLevel}, ExpNextForLVL: {PlayerStatistics.ExpNextLevel}, LVL: {PlayerStatistics.Level}, Card: {PlayerStatistics.ReceivedСards}");
